...
export const buildFallbackCodebook = (researchQuestion: string): ReviewCodebook => ({
  ...
  variables: [
    ...
    variable("study location", "Named city, region, or study area.", "text", [], "Extract named places only. Use English city/country names and normalizedPlaceName as City, Country when a clear city is present. Do not generate latitude/longitude or force vague regions/metropolitan areas into a city.", ["London, United Kingdom", "China"]),
    variable("country", "Study-area country extracted from the title or abstract, not author affiliation.", "text", [], "Use only the study-area country in English; use unclear if no study-area country is explicit.", ["China"]),
  ...
  extractionRules: [
    ...
    "Do not hallucinate locations, coordinates, methods, or energy outcomes.",
    "Do not force vague regions, metropolitan areas, selected neighborhoods, or ambiguous place names into city fields.",
