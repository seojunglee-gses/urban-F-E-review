...
export const buildFallbackCodebook = (researchQuestion: string): ReviewCodebook => ({
  ...
  variables: [
    ...
    variable("country", "Country associated with study location or authorship.", "text", [], "Prefer metadata country, otherwise coded location country.", ["United States"]),
    variable("climate context", "Climate or thermal context.", "categorical", ["hot-arid", "tropical", "temperate", "cold", "Mediterranean", "unclear"], "Use explicit climate descriptors or unclear.", ["tropical"]),
